...
<!-- Custom scripts for all pages--> <script src="<?= base_url('assets/'); ?>js/sb-admin2.min.js"></script>  
<script>     
...
$(this).next('.custom-filelabel').addClass("selected").html(fileName);     
    ...
    $(document).ready(function() {         
        $("#table-datatable").dataTable();     });     $('.alert-message').alert().delay(3500).slideUp('slow'); </script>  
</body>  
</html> 